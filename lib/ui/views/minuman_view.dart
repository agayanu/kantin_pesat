...
class MinumanView extends StatefulWidget {
  const MinumanView({Key? key}) : super(key: key);

  @override
  _MinumanViewState createState() => _MinumanViewState();
}

class _MinumanViewState extends State<MinumanView> {
  ...
  void _loadMenu() async {
    ...
    try {
      ...
      final menuUrl = '$baseURL/menu-minum?page=$_page';
      if (kDebugMode) {
